...
RE_S_BALL_MAX = -4 / T_SETTLING_ball;
...
% % % % output = []
% % % % begin_complex = 0.25;
% % % % for RE_1 = 2 * RE_S_BALL_MAX : 0.5 * RE_S_BALL_MAX : 25*RE_S_BALL_MAX
% % % %     for RE_2 = 1 * RE_S_BALL_MAX : 1 * RE_S_BALL_MAX : 25*RE_S_BALL_MAX
% % % %         for RE_3 = 1 * RE_S_BALL_MAX : 2 * RE_S_BALL_MAX : 100*RE_S_BALL_MAX
% % % %             for complex_portion = begin_complex * -atan(deg2rad(THETA_BALL_MAX)) * RE_2: 0.25 * -atan(deg2rad(THETA_BALL_MAX)) * RE_2 : 1 * -atan(deg2rad(THETA_BALL_MAX)) * RE_2
...
% % % % NON_DOM_POLES_BALL_C2 = complex_portion;
...
% % % % output = [output; RE_1, RE_3, RE_2, complex_portion, theta_max, os_perc, y_2settling;]
% % % % if theta_max > .7
...
NON_DOM_POLES_BALL_RE = 1.5 * RE_S_BALL_MAX;
NON_DOM_POLES_BALL_C = 0;
NON_DOM_POLES_BALL = conv([1 -NON_DOM_POLES_BALL_RE + NON_DOM_POLES_BALL_C * 1i], [1 -NON_DOM_POLES_BALL_RE - NON_DOM_POLES_BALL_C * 1i]);

NON_DOM_POLES_BALL_RE2 = 5 * RE_S_BALL_MAX;
NON_DOM_POLES_BALL_C2 = 0.25 * -atan(deg2rad(THETA_BALL_MAX)) * NON_DOM_POLES_BALL_RE2;

NON_DOM_POLES_BALL2 = conv([1 -NON_DOM_POLES_BALL_RE2 + NON_DOM_POLES_BALL_C2 * 1i], [1 -NON_DOM_POLES_BALL_RE2 - NON_DOM_POLES_BALL_C2 * 1i]);

% DOM_POLE = [1 -40*RE_S_BALL_MAX];
DOM_POLE = [1 -79*RE_S_BALL_MAX];
